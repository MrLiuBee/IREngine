...
class SouHuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='http://society.sohu.com/' + '.html', callback=self.parse_news_list)
        yield scrapy.Request(url='http://mil.sohu.com/' + '.html', callback=self.parse_news_list)
        yield scrapy.Request(url='http://news.sohu.com/' + '.html', callback=self.parse_news_list)
        yield scrapy.Request(url='http://business.sohu.com/' + '.html', callback=self.parse_news_list)
        yield scrapy.Request(url='http://sports.sohu.com/' + '.html', callback=self.parse_news_list)
        yield scrapy.Request(url='http://it.sohu.com/' + '.html', callback=self.parse_news_list)
